...
function App() {
  ...
  function newItem() {
    ...
    setSelected('new'); setDraft(fresh); setPayloadText(JSON.stringify(fresh.payload, null, 2)); setTab('content');
  }

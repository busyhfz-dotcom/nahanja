...
function PayloadFields({ payload, onChange }) {
  const entries = Object.entries(payload || {}).filter(([key, value]) => key !== 'id' && value !== null && !key.endsWith('Media'));

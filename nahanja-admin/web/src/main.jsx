...
function App() {
  ...
  async function uploadFile(file) {
    ...
    try {
      await upload(`nahanja/${crypto.randomUUID()}-${file.name.toLowerCase().replace(/[^a-z0-9._-]/g, '-')}`, file, {
        access: 'public',
